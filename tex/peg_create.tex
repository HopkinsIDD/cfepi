...
\begin{document}
\begin{tikzpicture}
\draw ( 0,-0 ) node (complete) {\includegraphics{../figures/peg_steps_pg_1.pdf}};
\draw (20,-0 ) node (initial)  {\includegraphics{peg_steps_pg_2.pdf}};
\draw ( 0,-15) node (t1s1)     {\includegraphics{peg_steps_pg_3.pdf}};
\draw (20,-15) node (t1s2)     {\includegraphics{peg_steps_pg_4.pdf}};
\draw (40,-15) node (t1s3)     {\includegraphics{peg_steps_pg_5.pdf}};
\draw ( 0,-27) node (t2s1)     {\includegraphics{peg_steps_pg_6.pdf}};
\draw (20,-27) node (t2s2)     {\includegraphics{peg_steps_pg_7.pdf}};
\draw (40,-27) node (t2s3)     {\includegraphics{peg_steps_pg_8.pdf}};
\draw ( 0,-39) node (t3s1)     {\includegraphics{peg_steps_pg_9.pdf}};
\draw (20,-39) node (t3s2)     {\includegraphics{peg_steps_pg_10.pdf}};
\draw (40,-39) node (t3s3)     {\includegraphics{peg_steps_pg_11.pdf}};
