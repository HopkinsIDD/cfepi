...
\begin{document}
\begin{tikzpicture}
\draw ( 5,-0 ) node (complete) {\includegraphics{figure5_pg_1}};
\draw (35,-0 ) node (initial)  {\includegraphics{figure5_pg_2}};
\draw ( 0,-15) node (t1s1)     {\includegraphics{figure5_pg_3}};
\draw (20,-15) node (t1s2)     {\includegraphics{figure5_pg_4}};
\draw (40,-15) node (t1s3)     {\includegraphics{figure5_pg_5}};
\draw ( 0,-27) node (t2s1)     {\includegraphics{figure5_pg_6}};
\draw (20,-27) node (t2s2)     {\includegraphics{figure5_pg_7}};
\draw (40,-27) node (t2s3)     {\includegraphics{figure5_pg_8}};
\draw ( 0,-39) node (t3s1)     {\includegraphics{figure5_pg_9}};
\draw (20,-39) node (t3s2)     {\includegraphics{figure5_pg_10}};
\draw (40,-39) node (t3s3)     {\includegraphics{figure5_pg_11}};
