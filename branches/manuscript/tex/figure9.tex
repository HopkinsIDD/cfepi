...
\begin{tikzpicture}
  ...
  \draw[-latex,impossible,line width=1mm, color=infection] (P11) -- (P22);
...
\begin{tikzpicture}
  ...
  \draw (4,3) node[node,actual,circle,fill=intervention] (P32) {}; %Random intervention effects
...
\begin{tikzpicture}
  ...
  \draw[-latex,potential,line width=1mm, color=recovery] (P12) -- (P13);
  \draw[-latex,recovery,line width=1mm, color=recovery] (P32) -- (P33);
...
\begin{tikzpicture}
  ...
  \draw (8,3) node[node,actual,circle,fill=intervention] (P33) {};
...
\begin{tikzpicture}
  ...
  \draw (12,3) node[node,actual,circle,fill=intervention] (P34) {};
