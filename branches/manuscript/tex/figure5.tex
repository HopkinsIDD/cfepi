...
\begin{tikzpicture}
  ...
  \draw (0 ,6.5) node[below,text=black] {\Huge $t=0$};
  \draw (4 ,6.5) node[below,text=black] {\Huge $t=1$};
  \draw (8 ,6.5) node[below,text=black] {\Huge $t=2$};
  \draw (12,6.5) node[below,text=black] {\Huge $t=3$};
  \draw[-latex,line width=1mm,white!60!black] (-2,0) -- (-2,4.5) node[midway,above,rotate=90,text=black] {\Huge \textbf{Population}};
...
\begin{tikzpicture}
  ...
  \draw (8 ,6.5) node[below,text=black] {\Huge $t=2$};
  \draw (12,6.5) node[below,text=black] {\Huge $t=3$};
  \draw[-latex,line width=1mm,white!60!black] (-1.75,0) -- (-1.75,4.5) node[midway,above,rotate=90,text=black] {\Huge \textbf{Population}};
  \draw (-1.25,0  ) node[text=black] {\Huge $p_1$};
  \draw (-1.25,1.5) node[text=black] {\Huge $p_2$};
  \draw (-1.25,3  ) node[text=black] {\Huge $p_3$};
  \draw (-1.25,4.5) node[text=black] {\Huge $p_4$};
