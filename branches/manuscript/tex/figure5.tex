...
\begin{tikzpicture}
  ...
  \draw[-latex,line width=1mm, color=infection] (P11) -- (P22);
  \draw[-latex,line width=1mm, color=infection] (P11) -- (P32);
  \draw[-latex,line width=1mm, color=nothing] (P11) -- (P42);
  
  \draw[-latex,line width=1mm, color=nothing] (P11) -- (P12);
...
\begin{tikzpicture}
  ...
  \draw[-latex,line width=1mm, color=nothing] (P11) -- (P12);
  \draw[-latex,line width=1mm, color=nothing] (P22) -- (P23);
  
  \draw[-latex,line width=1mm, color=nothing] (P12) -- (P23);
  \draw[-latex,line width=1mm, color=nothing] (P12) -- (P43);
  \draw[-latex,line width=1mm, color=nothing] (P22) -- (P43);
  \draw[-latex,line width=1mm, color=nothing] (P32) -- (P43);
  \draw[-latex,line width=1mm, color=infection] (P12) -- (P33);
  \draw[-latex,line width=1mm, color=infection] (P22) -- (P33);
  \draw[-latex,line width=1mm, color=infection] (P32) -- (P23);
...
\begin{tikzpicture}
  ...
  \draw[-latex,line width=1mm, color=nothing] (P33) -- (P34);
  \draw[-latex,line width=1mm, color=nothing] (P33) -- (P24);
  \draw[-latex,line width=1mm, color=nothing] (P23) -- (P44);
...
\begin{tikzpicture}
  ...
  \draw[-latex,line width=1mm, color=infection] (P11) -- (P22);
  \draw[-latex,line width=1mm, color=nothing] (P11) -- (P32);
...
\begin{tikzpicture}
  ...
  \draw (4,3) node[node,circle,fill=susceptible] (P32) {};
...
\begin{tikzpicture}
  ...
  \draw[-latex,line width=1mm, color=infection] (P12) -- (P33);
  \draw[-latex,line width=1mm, color=infection] (P22) -- (P33);
  \draw[-latex,line width=1mm, color=infection] (P32) -- node[pos=.35,text=black]{\Leftscissor} (P23);
  
  \draw[-latex,line width=1mm, color=recovery] (P12) -- (P13);
  \draw[-latex,line width=1mm, color=recovery] (P32) -- node[pos=.35,text=black]{\Leftscissor} (P33);
...
\begin{tikzpicture}
  ...
  \draw (8,3) node[node,circle,fill=infection] (P33) {};
...
\begin{tikzpicture}
  ...
  \draw (12,3) node[node,circle,fill=infection] (P34) {};
  \draw (12,4.5) node[node,circle,fill=infection] (P44) {};
