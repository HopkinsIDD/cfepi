...
\tikzstyle{custom}=[-{Latex[scale=1,length=1.5mm,width=1.5mm]}]
...
\begin{tikzpicture}
  %% Infectious Contacts
  \draw (-15,2) node[node] (P11) {$\bm{\bm{P_{i,t}}}$};
  \draw (-15,0) node[node] (P21) {$\bm{\bm{P_{j,t}}}$};
  \draw (-13,2) node[edge, contact] (E121) {$\bm{C^*_{i,j,t}}$};
  \draw (-12,3) node[node,intervention] (I) {$\bm{N}$};
  \draw (-11,2) node[edge, intervention] (I121) {$\bm{N_{i,j,t}}$};
  \draw (-5,0) node[node] (P22) {$\bm{P_{j,t+1}}$};
  \draw (-10,0) node[edge] (C121) {$\bm{C_{i,j,t}}$};
  ...
  %% Recovery
  \draw (0,0) node[node] (P21) {$\bm{P_{j,t}}$};
  \draw (2,2) node[edge, recovery] (E121) {$\bm{R^*_{j,t}}$};
  \draw (3,3) node[node, intervention] (I) {$\bm{N}$};
  \draw (4,2) node[edge, intervention] (I11) {$\bm{N_{j,t}}$};
  \draw (10,0) node[node] (P22) {$\bm{P_{j,t+1}}$};
  \draw (5,0) node[ edge] (R121) {$\bm{R_{j,t}}$};
  ...
  %% Legend thingies
  \draw[-latex,line width=1mm,white!60!black] (-12,-1) -- (-8,-1) node[midway, below,text=black] {\textbf{Time}};
  \draw[-latex,line width=1mm,white!60!black] (3,-1) -- (7,-1) node[midway, below,text=black] {\textbf{Time}};
