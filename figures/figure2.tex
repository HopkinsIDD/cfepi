...
\begin{tikzpicture}
  ...
  \draw (4,1.5) node[intervened node fill={infection,white}] (P22) {$P_{2,2}$};
  ...
  \draw (8,1.5) node[intervened node fill={infection,white}] (P23) {$P_{2,3}$};
  \draw (8,3) node[node,recovery] (P33) {$P_{3,3}$};
  \draw (8,4.5) node[node] (P43) {$P_{4,3}$};

  \draw (12,0) node[node,recovery] (P14) {$P_{1,4}$};
  \draw (12,1.5) node[intervened node fill={recovery,white}] (P24) {$P_{2,4}$};
  \draw (12,3) node[node,recovery] (P34) {$P_{3,4}$};
  \draw (12,4.5) node[intervened node fill={infection,white}] (P44) {$P_{4,4}$};
